...
from model import PyramidEncoder, Generator, Discriminator, Cooccurv2Discriminator, MultiProjectors
from models.networks import PatchNCELoss
        ...
        if get_rank() == 0:
            ...
            if i % 200 == 0:
                with torch.no_grad():
                    ...
                    utils.save_image(
                        sample,
                        f"sample_mask_r16-r4_cdv2_patchnce/{str(i).zfill(6)}.png",
            ...
            if i % 10000 == 0:
                torch.save(
                    ...
                    f"checkpoint_mask_r16-r4_cdv2_patchnce/{str(i).zfill(6)}.pt",
                )
...
if __name__ == "__main__":
    ...
    if get_rank() == 0 and wandb is not None and args.wandb:
        wandb.init(project="cooccur_mask_r16-r4_cdv2_patchnce")
